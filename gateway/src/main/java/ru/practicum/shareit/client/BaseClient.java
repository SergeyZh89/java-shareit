...
public class BaseClient {
    ...
    protected <T> ResponseEntity<Object> put(String path, long userId, @Nullable Map<String, Object> parameters, T body) {
        return makeAndSendRequest(PUT, path, userId, parameters, body);
    }
    ...
    private HttpHeaders defaultHeaders(Long userId) {
        ...
        headers.setAccessControlAllowMethods(List.of(PUT, POST, GET, DELETE, OPTIONS));
        headers.setAccessControlAllowCredentials(false);
//        headers.setAccessControlAllowHeaders(List.of("X-Requested-With", "X-HTTP-Method-Override", "Content-Type", "Accept"));
